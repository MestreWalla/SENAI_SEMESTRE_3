...
if (!empty($_POST)) {
    ...
    $stmt = $pdo->prepare('INSERT INTO contatos (id_contato, nome, email, cell, pizza, cadastro) VALUES (?, ?, ?, ?, ?, ?)');
    $stmt->execute([$id_contato, $nome, $email, $cell, $pizza, $cadastro]);
    // Mensagem de saída
...
<div class="content update">
    ...
    <form action="create.php" method="post">
        <label for="id_contato"><i class="fas fa-id-card"></i>.  ID</label>
        ...
        <label for="cell"><i class="fas fa-mobile-alt"></i>.  Celular</label>
        <input type="text" name="email" placeholder="seuemail@seuprovedor.com.br" id_contato="email">
        <input type="text" name="cell" placeholder="(XX) X.XXXX-XXXX" id_contato="cell">
        <label for="pizza"><i class="fas fa-pizza-slice"></i>.  Sabor Pizza</label>
        <label for="cadastro"><i class="far fa-calendar-alt"></i>.  Data do Pedido</label>
